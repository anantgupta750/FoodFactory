...
class MenuAdapter(private val fragment: Fragment, val categories: ArrayList<Category>) : RecyclerView.Adapter<MenuAdapter.MyViewHolder>() {
    ...
    public class MyViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun binder(category: Category, fragment: Fragment){
            ...
            wrapper.setOnClickListener {
                val dir = MenuFragmentDirections.actionMenuFragmentToSubMenuFragment(category.name.toString())
